...
export const tracks: Track[] = [
  {
    ...
    summary:
      'Ruta ideal para principiantes. Aprendes variables, funciones y logica con misiones cortas de estilo arcade.',
    accent: '#45e0ff',
    ...
    levels: [
      {
        ...
        story:
          'La academia necesita verificar el canal de salida de la nave. Tu primera mision es emitir una senal visible desde Python.',
        ...
        concepts: ['print', 'variables', 'salida estandar'],
        validator: 'python-greeting',
      },
      {
        id: 'python-2',
        order: 2,
        title: 'Variables de energia',
        subtitle: 'Siguiente mision desbloqueable.',
        xp: 15,
        duration: '4 min',
        difficulty: 'beginner',
        goal: 'Proxima leccion de la ruta Python.',
        story: 'Se desbloquea cuando completes la primera prueba.',
        expectedOutput: '80',
        starterCode: 'energia = 80\n',
        hints: ['Proxima etapa.'],
        concepts: ['variables', 'numeros'],
        validator: 'python-greeting',
      },
      {
        id: 'python-3',
        ...
        difficulty: 'beginner',
        goal: 'Proxima leccion de la ruta Python.',
        story: 'Se desbloquea despues de dominar la base.',
  ...
  },
  {
    id: 'php',
    name: 'PHP Harbor',
    tagline: 'Backend clasico en formato de mision rapida.',
    summary:
      'Ruta pensada para aprender sintaxis, formularios y estructuras basicas de PHP desde una experiencia de navegador.',
    accent: '#ffb84d',
    ...
    levels: [
      {
        ...
        story:
          'El puerto de datos necesita una respuesta simple. Usa la sintaxis basica de PHP para emitir el saludo inicial.',
        expectedOutput: 'Hola, Codebreaker',
        starterCode: '$mensaje = "Hola, Codebreaker";\n\n// Muestra el mensaje\n',
        hints: [
          'PHP suele mostrar salida con echo.',
          'Tambien puedes imprimir directamente la variable $mensaje.',
        ],
        concepts: ['echo', 'variables', 'salida estandar'],
      ...
      },
      {
        ...
        duration: '4 min',
        difficulty: 'beginner',
        goal: 'Proxima leccion de la ruta PHP.',
        story: 'Se desbloquea cuando superes la leccion de bienvenida.',
        expectedOutput: '3',
      ...
      },
      {
        ...
        goal: 'Proxima leccion de la ruta PHP.',
        story: 'Se desbloquea mas adelante en el mapa.',
        expectedOutput: 'Mision enviada',
